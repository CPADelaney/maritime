...
class Settings(BaseSettings):
    ...
    psix_url: str = Field(default="https://cgmix.uscg.mil/xml/PSIXData.asmx", alias="PSIX_URL")
    ...
    def sqlalchemy_url(self) -> str:
        if self.database_url:
            ...
            if 'postgresql+psycopg2://' in url:
                ...
                # Default postgresql:// should use psycopg3 
        ...
        if self.pg_host and self.pg_user and self.pg_password and self.pg_db:
            # Build URL with psycopg3 dialect
            return (
                f"postgresql+psycopg://{quote(self.pg_user)}:{quote(self.pg_password)}"
